...
const BottomNavBar: React.FC = () => {
	...
	return (
		<nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-container bg-white border-t border-border z-40 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
